      ...
      <Stack spacing={isMobile ? 2 : 3} direction={isMobile ? "column" : "row"}>
        ...
        <Box sx={{ flexGrow: 1 }}>
          <Grid container spacing={isMobile ? 2 : 3}>
            ...
            {/* 积分（edge 自建）：管理员可直接调整余额。官方开源版此处是写死 value={0} 的装饰位。 */}
            <SettingForm title={t("application:vas.points")} noContainer lgWidth={6}>
              ...
              />
              <NoMarginHelperText>调整用户积分余额（可正可负的消费能力）。</NoMarginHelperText>
            </SettingForm>
            ...
            {/* 原用户组 / 用户组过期：来自组套餐（settings.group_pack），只读展示。 */}
